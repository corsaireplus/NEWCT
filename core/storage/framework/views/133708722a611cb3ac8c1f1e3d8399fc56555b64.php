    ...
    <div class="navbar__left">
        ...
        <form class="navbar-search">
            <input type="search" name="#0" class="navbar-search-field" id="searchInput" autocomplete="off"
                placeholder="<?php echo app('translator')->get('Chercher Menu...'); ?>">
...
<!-- navbar-wrapper end -->
<?php /**PATH /Applications/MAMP/htdocs/NEWCT/core/resources/views/staff/partials/topnav.blade.php ENDPATH**/ ?>