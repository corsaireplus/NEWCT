                    ...
                    <table class="table table--light style--two custom-data-table white-space-wrap">
                        ...
                        <tbody>
                            ...
                            <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                ...
                                <td data-label="<?php echo app('translator')->get('Date'); ?>"><?php echo e(date('d-m-Y', strtotime($rdvliste->date))); ?></td>
                                <?php if($rdvliste->observation !== NULL): ?>
                                <td data-label="<?php echo app('translator')->get('Observation'); ?>"><?php echo e($rdvliste->observation); ?></td>
                                <?php else: ?> <td data-label="<?php echo app('translator')->get('Observation'); ?>"></td> <?php endif; ?>
                                <td data-label="<?php echo app('translator')->get('Client'); ?>"><?php echo e($rdvliste->client->nom); ?></td>
                                <td data-label="<?php echo app('translator')->get('Contact'); ?>"><?php echo e($rdvliste->client->contact); ?></td>
                                <?php if($rdvliste->adresse): ?>
                                <td data-label="<?php echo app('translator')->get('Code Postal'); ?>"><?php echo e($rdvliste->adresse->code_postal); ?></td>
                                
                                <?php else: ?>
                                <td data-label="<?php echo app('translator')->get('Code Postal'); ?>">N/A</td>
                             
                                <?php endif; ?>
                                <?php if($rdvliste->adresse): ?>
                                <td data-label="<?php echo app('translator')->get('Adresse'); ?>"><?php echo e($rdvliste->adresse->adresse); ?></td>
                                <?php else: ?>
                                <td data-label="<?php echo app('translator')->get('Adresse'); ?>">N/A</td>
                                <?php endif; ?>
                                <td data-label="<?php echo app('translator')->get('Status'); ?>"> <?php if($rdvliste->status == 0 && $rdvliste->chauffeur ): ?>
                                    <span class="badge badge--primary"><?php echo app('translator')->get('En Cours'); ?></span>
                                    <?php elseif($rdvliste->status == 10 && !$rdvliste->chauffeur ): ?>
                                    <span class="badge badge--danger"><?php echo app('translator')->get('Non validé'); ?></span>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('staff.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/NEWCT/core/resources/views/staff/rdv/rdvclient.blade.php ENDPATH**/ ?>