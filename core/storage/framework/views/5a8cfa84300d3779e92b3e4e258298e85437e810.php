                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            ...
                            <h2 class="text-white"><?php echo e(showAmount($totalValeurColis)); ?> <?php echo e($general->cur_sym); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="col-xxl-4 col-sm-6">
            <div class="card bg--orange has-link box--shadow2">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            <span class="text-white text--small"><?php echo app('translator')->get('Total Payé'); ?></span>
                            <h2 class="text-white"><?php echo e(showAmount($totalPaiements)); ?> <?php echo e($general->cur_sym); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
         ...
         <div class="col-xxl-4 col-sm-6">
            <div class="card bg--pink has-link box--shadow2">
                <a href="<?php echo e(route('staff.conteneurs.listenonpaye', encrypt($container_id))); ?>" class="item-link"></a>
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-4">
                        ...
                        <div class="col-8 text-end">
                            ...
                            <h2 class="text-white"><?php echo e(showAmount($totalValeurColis - $totalPaiements)); ?> <?php echo e($general->cur_sym); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
                         ...
                         <table class="table table--light style--two">
                            ...
                            <?php if($miss->transaction): ?>   
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(getAmount($miss->transaction->paymentInfo->sender_amount)); ?> <?php echo e(auth()->user()->branch->currencie); ?></td>
                                    ...
                                    <td>
                                    <a href="<?php echo e(route('staff.conteneurs.coliscancel',[encrypt($miss->transaction->id),encrypt($mission->idcontainer)])); ?>" title="" class="icon-btn btn--danger ml-1 delivery" data-contenaire="<?php echo e(encrypt($mission->idcontainer)); ?>" data-code="<?php echo e(encrypt($miss->id)); ?>"> Annuler</a>
                                    <?php else: ?> 
...
<?php echo $__env->make('staff.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/NEWCT/core/resources/views/staff/container/liste.blade.php ENDPATH**/ ?>