...
<div class="row mb-none-30">
    <div class="col-lg-12 col-md-12 mb-30">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('staff.transfert.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" style="background-color : green; color: #ffffff" class="form-control" id="reference" name="reference" value="<?php echo e($courierInfo->reftrans); ?>" maxlength="40" required="">
                                        </div>
                                        <div class="form-group col-lg-6">
                            ...
                            <div class="card border--primary mt-3">
                                <h5 class="card-header bg--primary  text-white"><?php echo app('translator')->get('Information Colis'); ?>
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-light float-end addUserData"><i
                                            class="la la-fw la-plus"></i><?php echo app('translator')->get('Ajouter Ligne'); ?>
                                    </button>
                                </h5>
                                ...
                                <div class="row" id="addedField">
                                        <?php $__currentLoopData = $courierInfo->courierDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="row single-item gy-2">
                                                <div class="col-md-3">
                                                    <select class="form-control selected_type"  id="courier_type_<?php echo e($loop->index); ?>" onchange="currierType(<?php echo e($loop->index); ?>)" name="courierName[]" required>
                                                        <!-- <option disabled selected value=""><?php echo app('translator')->get('Choisir Colis'); ?></option> -->
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group mb-3">
                                                        <input type="number" class="form-control quantity currier_quantity_<?php echo e($item->id); ?>" value="<?php echo e($item->qty); ?>"  name="quantity[]" onkeyup="courierQuantity(<?php echo e($item->id); ?>)"  required>
                                                        <span class="input-group-text unit"><i class="las la-balance-scale"></i></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="input-group">
                                                        <input type="text"  class="form-control single-item-amount currier_fee_<?php echo e($item->id); ?> montant" value="<?php echo e(getAmount($item->fee)); ?>" name="amount[]" required>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" class="form-control" disabled id="deja_paye" value="<?php echo e($deja_payer); ?>" name="deja_paye" maxlength="40" required="">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            ...
                                            <textarea name="message" id="observation" rows="6" class="form-control" placeholder="<?php echo app('translator')->get('Observation ou Note'); ?>"><?php echo e(old('message')); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="btn btn--primary h-45 w-100 Submitbtn"> <?php echo app('translator')->get('Modifier Transaction'); ?></button>
                    ...
                    <!-- <div class="form-group">
                            <button type="submit" class="btn btn--primary btn-block"><i class="fa fa-fw fa-paper-plane"></i> <?php echo app('translator')->get('Enregistrer Transfert'); ?></button>
                         </div> -->
                </form>
            </div>
        </div>
