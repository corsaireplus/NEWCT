                ...
                <div class="card-body p-0">
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            <thead>
                            <tr>
                                <th><?php echo app('translator')->get('Manage-Staff'); ?></th>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            ...
                                            <span class="small d-block"> <a href="<?php echo e(route('admin.branch.manager.edit',@$log->user->id)); ?>"><span>@</span><?php echo e(@$log->user->username); ?></a> </span>
                                            <?php else: ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/NEWCT/core/resources/views/admin/reports/notification_history.blade.php ENDPATH**/ ?>