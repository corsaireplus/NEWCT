                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-bold d-block">
                                                <?php echo e(getAmount(@$courierInfo->paymentInfo->final_amount)); ?>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline--success confirmationBtn"
                                                data-action="<?php echo e(route('staff.courier.receive', $courierInfo->id)); ?>"
                                                data-question="<?php echo app('translator')->get('Are you sure to received this courier?'); ?>">
                                                <i class="las la-check-circle"></i> <?php echo app('translator')->get('Received'); ?>
                                            </button>
                                        </td>
                                    </tr>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.search-form','data' => ['placeholder' => 'Courier Code']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Courier Code']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('staff.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/NEWCT/core/resources/views/staff/courier/upcoming.blade.php ENDPATH**/ ?>