                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                    ...
                                    <a href="<?php echo e(route('staff.container.detaildecharge', encrypt($mission->idcontainer))); ?>" title="" class="icon-btn btn--success ml-1 " data-code="<?php echo e($mission->idmission); ?>"><?php echo app('translator')->get('Liste Colis'); ?></a>
                                    <?php endif; ?>
...
<div class="modal fade" id="paymentBy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('staff.dechargement.end')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('staff.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/NEWCT/core/resources/views/staff/dechargement/index.blade.php ENDPATH**/ ?>