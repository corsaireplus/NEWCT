        ...
        <tbody>
                          ...
                          <?php if($rdvliste->paymentInfo->sender_amount != 0 && $rdvliste->paymentInfo->sender_amount>0): ?>
                            ...
                            <td data-label="<?php echo app('translator')->get('Action'); ?>"> 
                                ...
                                <td data-label="<?php echo app('translator')->get('Destinataire'); ?>"><?php echo e($rdvliste->receiver->nom); ?></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('staff.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/NEWCT/core/resources/views/staff/transfert/index.blade.php ENDPATH**/ ?>