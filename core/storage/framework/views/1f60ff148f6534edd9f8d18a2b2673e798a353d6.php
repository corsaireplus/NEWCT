            ...
            <form action="<?php echo e(route('staff.transactions.livraison_validate')); ?>" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <p><?php echo app('translator')->get('Entrer les Informations de livraison'); ?></p>
 ...
 <?php /**PATH /Applications/MAMP/htdocs/NEWCT/core/resources/views/staff/modal/livraison.blade.php ENDPATH**/ ?>