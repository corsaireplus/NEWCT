                         ...
                         <table class="table table--light style--two">
                            ...
                            <?php if($miss->transaction->status != 2): ?>   
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(getAmount($miss->transaction->paymentInfo->receiver_amount - $miss->payer)); ?> <?php echo e(auth()->user()->branch->currencie); ?></td>
...
<a href="<?php echo e(route('staff.conteneurs.export_nonpayer',encrypt($mission->idcontainer))); ?>"><button class="btn btn-outline--primary m-1">
...
<?php echo $__env->make('staff.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/NEWCT/core/resources/views/staff/container/listereceivenonpaye.blade.php ENDPATH**/ ?>