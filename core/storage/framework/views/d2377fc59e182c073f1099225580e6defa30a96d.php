<form action="<?php echo e(route('staff.mission.end')); ?>" method="POST">
                ...
                <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn--primary"><?php echo app('translator')->get('Terminer'); ?></button>
             </div>
            </form><?php /**PATH /Applications/MAMP/htdocs/NEWCT/core/resources/views/staff/modal/fin.blade.php ENDPATH**/ ?>