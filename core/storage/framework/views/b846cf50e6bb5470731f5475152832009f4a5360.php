                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                    ...
                                    <?php if($mission->status == 0): ?>
                                    <a href="<?php echo e(route('staff.conteneurs.assign', encrypt($mission->idcontainer))); ?>" title="" class="icon-btn btn--info ml-1 delivery" data-code="<?php echo e($mission->idcontainer); ?>"><?php echo app('translator')->get('Ajouter Colis'); ?></a>

                                    <?php endif; ?>
                                    <?php if($mission->envois->count() > 0): ?>
                                    <a href="<?php echo e(route('staff.conteneurs.conteneurliste', encrypt($mission->idcontainer))); ?>" title="" class="icon-btn btn--success ml-1 " data-code="<?php echo e($mission->idcontainer); ?>"><?php echo app('translator')->get('Liste Colis'); ?></a>
                                    <?php endif; ?>
...
<div class="modal fade" id="ropenBy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('staff.conteneurs.reopen')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="paymentBy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('staff.conteneurs.conteneurcharge')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo method_field('POST'); ?>
                <input type="hidden" name="code">
                <div class="modal-body">
...
<a href="<?php echo e(route('staff.conteneurs.create')); ?>">
<button type="button" class="btn btn-outline--primary m-1 ">
                                    <i class="fa la-plus"></i> <?php echo app('translator')->get('Ajouter Conteneur'); ?>
                                </button>
</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('staff.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/NEWCT/core/resources/views/staff/container/index.blade.php ENDPATH**/ ?>