            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)"
                        class="{{ menuActive(['admin.branch*', 'admin.courier.branch.income'], 3) }}">
                        <i class="menu-icon las la-code-branch"></i>
                        <span class="menu-title">@lang('Branch Control') </span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive(['admin.branch*', 'admin.courier.branch.income'], 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.courier.branch.income') }}">
                                <a href="{{ route('admin.courier.branch.income') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item  {{ menuActive(['admin.courier.info*', 'admin.courier.invoice']) }}">
                ...
                <li class="sidebar-menu-item  {{ menuActive(['admin.customer.index']) }}">
                    <a href="{{ route('admin.customer.index') }}" class="nav-link">
                        <i class="menu-icon las la-user-friends"></i>
                        <span class="menu-title">@lang('Customer List')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.courier.unit*', 3) }}">
                        <i class="menu-icon las la-tasks"></i>
                        <span class="menu-title">{{ __($general->site_name) }} @lang('Setting')</span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.courier.unit*', 2) }} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.courier.unit.index') }} ">
                                <a href="{{ route('admin.courier.unit.index') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Manage Unit')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.courier.unit.type.index') }} ">
                                <a href="{{ route('admin.courier.unit.type.index') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
