                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    ...
                                    <a href="{{route('staff.container.detaildecharge', encrypt($mission->idcontainer))}}" title="" class="icon-btn btn--success ml-1 " data-code="{{$mission->idmission}}">@lang('Liste Colis')</a>
                                    @endif
                                    @if($mission->status == 1)
...
<div class="modal fade" id="paymentBy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('staff.dechargement.end')}}" method="POST">
                @csrf
                @method('POST')
