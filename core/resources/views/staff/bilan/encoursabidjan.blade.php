...
<div class="row mt-50 mb-none-30">
        ...
        <div class="col-xl-6 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--3 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{getAmount($totalResteAPayer)}} FCFA</span>
                    </div>
        ...
        <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <form action="{{route('staff.encours.abidjan')}}" method="GET" class="form-inline float-sm-right bg--white">
                        ...
                        <table class="table table--light style--two custom-data-table white-space-wrap">
                            ...
                            @forelse($encours as $trans)
                                ...
                                <td data-label="@lang('Montant')">
                                    <span class="font-weight-bold">{{getAmount($trans->prix)}} FCFA</span>
                                </td>

                                <td class="text-center" data-label="@lang('Montant paye')">
                                     <span class="font-weight-bold">{{getAmount($trans->montant_total_paye)}} FCFA</span>
                                 
                                </td>
                                 <td class="text-center" data-label="@lang('Reste a payer')">
                                     <span class="font-weight-bold">{{getAmount($trans->reste_a_payer)}} FCFA</span>
    ...
    <form action="{{route('staff.bilan.encours.searchabidjan')}}" method="GET" class="form-inline float-sm-right bg--white">
        <div class="input-group has_append ">
            <input name="date" type="text" data-range="true" data-multiple-dates-separator=" - " data-language="en" class="datepicker-here form-control" data-position='bottom right' placeholder="@lang('Min date - Max date')" autocomplete="off" value="{{ @$dateSearch }}">
            <div class="input-group-append">
                <button class="btn btn--primary" type="submit"><i class="fa fa-search"></i></button>
