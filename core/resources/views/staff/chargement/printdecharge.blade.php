...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Conteneur N째 {{$mission->numero}}</title>
    <style type="text/css" >
    .clearfix:after {
  content: "";
  display: table;
...
.highlight {
  background-color: #ffff99; /* Couleur jaune pour la surlignature */
}
...
@media print {
  ...
  <body onload="window.print();">
    <header class="clearfix">
      ...
      <h1>LISTE DES COLIS DU CONTENEUR {{$mission->numero}} </h1>
      <div id="company" class="clearfix">
        <div>Challenge Transit</div>
        <div>,<br /></div>
      ...
      <div id="project">
        ...
        <div><span>CONTENEUR N째</span> {{$mission->numero}} </div>
    ...
    <main>
      <table>
        ...
        @if($miss->colis)                             
          <tr class="{{ $miss->colis->previously_in_container != 0 ? 'highlight' : '' }}">
