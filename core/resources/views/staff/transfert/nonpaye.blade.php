        ...
        <tbody>
                          ...
                          @if($rdvliste->paymentInfo->sender_amount != 0 && $rdvliste->paymentInfo->sender_amount>0 )
                            ...
                            <td data-label="@lang('Action')"> 
                                @if(auth()->user()->username == 'bagate' || auth()->user()->username == 'mouna' || auth()->user()->username == 'kanga' ) 
                                ...
                                <td data-label="@lang('Reste à Payer')">{{getAmount($rdvliste->paymentInfo->sender_amount -$rdvliste->payer)}} € </td>
