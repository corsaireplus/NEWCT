                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" class="form-control form-control-lg" id="phone" value="{{$courierInfo->sender->contact}}" name="sende_phone" maxlength="40" disabled required="">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" class="form-control form-control-lg" id="sender_name" name="sender_name" value="{{$courierInfo->sender->nom}}" placeholder="@lang(" Expediteur")" maxlength="40" required="">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            <label for="sender_email" class="form-control-label font-weight-bold">@lang('Reference')*</label>
                                            <input type="text" style="background-color : green; color: #ffffff" class="form-control form-control-lg" id="reference" name="reference" value="{{$courierInfo->reference_souche}}" maxlength="40" required="">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="sender_address" class="form-control-label font-weight-bold">@lang('Type Envoi')</label>
                                            <select class="form-control form-control-lg" name="envoi" id="envoi" required="">
                            ...
                            <div class="card border--primary mt-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="receiver_phone" class="form-control-label font-weight-bold">@lang('Contact')*</label>
                                            <input type="text" class="form-control form-control-lg" id="receiver_phone" name="receiver_phone" value="{{$courierInfo->receiver->contact}}" required="">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="receiver_name" class="form-control-label font-weight-bold">@lang('Nom')*</label>
                                            <input type="text" class="form-control form-control-lg" id="receiver_name" name="receiver_name" value="{{$courierInfo->receiver->nom}}" maxlength="40" required="">
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            <label for="receiver_address" class="form-control-label font-weight-bold">@lang('Adresse')</label>
                                            <input type="text" class="form-control form-control-lg" id="receiver_address" name="receiver_address" @if($courierInfo->receiver_adresse != null) value="{{$courierInfo->receiver_adresse->adresse}}" @else value="" placeholder="Entrer Adresse" @endif >
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="=branch" class="form-control-label font-weight-bold">@lang('Destination')*</label>
                                    ...
                                    <div class="row">
                                        <!-- <div class="form-group col-lg-6">
                                                <label for="receiver_address" class="form-control-label font-weight-bold">@lang('Reference')*</label>
                                                <input type="text" class="form-control form-control-lg" id="reference" name="reference" placeholder="@lang("Reference")" value="{{old('reference')}}" required="">
                                            </div> -->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border--primary mt-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="sender_phone" class="form-control-label font-weight-bold">@lang('DEJA PAYER')</label>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn--primary btn-block"><i class="fa fa-fw fa-paper-plane"></i> @lang('Modifier Transfert')</button>
                                    </div>
                                </div>
                            </div>
                        </div>
