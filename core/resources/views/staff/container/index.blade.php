                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    ...
                                    @if($mission->status == 0)
                                    <a href="{{route('staff.conteneurs.assign', encrypt($mission->idcontainer))}}" title="" class="icon-btn btn--info ml-1 delivery" data-code="{{$mission->idcontainer}}">@lang('Ajouter Colis')</a>

                                    @endif
                                    @if($mission->envois->count() > 0)
                                    <a href="{{route('staff.conteneurs.conteneurliste', encrypt($mission->idcontainer))}}" title="" class="icon-btn btn--success ml-1 " data-code="{{$mission->idcontainer}}">@lang('Liste Colis')</a>
                                    @endif
...
<div class="modal fade" id="ropenBy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('staff.conteneurs.reopen')}}" method="POST">
                @csrf
                @method('POST')
...
<div class="modal fade" id="paymentBy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('staff.conteneurs.conteneurcharge')}}" method="POST">
                @csrf
                @method('POST')
                <input type="hidden" name="code">
                <div class="modal-body">
...
<a href="{{route('staff.conteneurs.create')}}">
<button type="button" class="btn btn-outline--primary m-1 ">
                                    <i class="fa la-plus"></i> @lang('Ajouter Conteneur')
                                </button>
</a>
