                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            ...
                            <h2 class="text-white">{{ showAmount($totalValeurColis) }} FCFA</h2>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="col-xxl-6 col-sm-6">
            <div class="card bg--orange has-link box--shadow2">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-8 text-end">
                            <span class="text-white text--small">@lang('Total Payé à Abidjan')</span>
                            <h2 class="text-white">{{ showAmount($totalAbidjan) }} FCFA</h2>
                        </div>
                    </div>
                </div>
            </div>
         ...
         <div class="col-xxl-6 col-sm-6">
            <div class="card bg--pink has-link box--shadow2">
                <a href="{{route('staff.conteneurs.listereceivenonpaye', encrypt($container_id))}}" class="item-link"></a>
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-4">
                        ...
                        <div class="col-8 text-end">
                            ...
                            <h2 class="text-white">{{ showAmount($totalValeurColis - $totalPaiements) }} FCFA</h2>
                        </div>
                    </div>
                </div>
            </div>
                         ...
                         <table class="table table--light style--two">
                            ...
                            @if($miss->transaction)   
                                ...
                                <tr>
                                    ...
                                    {{$miss->transaction->receiver->nom}}
                                      
                                    </td>

                                    <td data-label="@lang('Contact')">
                                    {{$miss->transaction->receiver->contact}}
                                    </td>
                                    <td>{{getAmount($miss->transaction->paymentInfo->receiver_amount)}} {{auth()->user()->branch->currencie}}</td>
...
<x-back route="{{route('staff.conteneurs.conteneureceive')}}" />
