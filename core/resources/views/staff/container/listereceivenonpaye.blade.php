                         ...
                         <table class="table table--light style--two">
                            ...
                            @if($miss->transaction->status != 2)   
                                ...
                                <tr>
                                    ...
                                    <td>{{getAmount($miss->transaction->paymentInfo->receiver_amount - $miss->payer)}} {{auth()->user()->branch->currencie}}</td>
...
<a href="{{route('staff.conteneurs.export_nonpayer',encrypt($mission->idcontainer))}}"><button class="btn btn-outline--primary m-1">
